...
import next_btm from '../../assets/next-icon.png'
import back_btm from '../../assets/back-icon.png'
...
const slideBackward = () => {
  ...
  return (
    <div className='testimonials'>
      <img src={next_btm} alt=""  className='next-btn' onClick={slideForward} />
        <img src={back_btm} alt=""  className='back-btn' onClick={slideBackward}/>
